getPokemonsQuery(String category, bool withGen) {
  if (!withGen) {
    return """query getPokemons(\$name: String!, \$order: order_by, \$limit: Int, \$offset: Int) {
        pokemons: pokemon_v2_pokemon(where: {id: {_lt: 898}, name: {_regex: \$name}}, order_by: {$category: \$order}, limit: \$limit, offset: \$offset) {
            id
            name
        }
...
""";
  ...
  return """query getPokemons(\$gen: Int, \$name: String!, \$order: order_by, \$limit: Int, \$offset: Int) {
...
getPokemonQuery() {
  return """query getPokemon(\$id: Int!, \$name:String!) {
